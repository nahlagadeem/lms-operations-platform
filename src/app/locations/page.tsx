...
function pageText(locale: "en" | "ar") {
  ...
  return {
    ...
    description: "Manage internal venues, external locations, online delivery options, and international locations used in course operations.",
    ...
    noResults: "No locations matched the current filters.",
